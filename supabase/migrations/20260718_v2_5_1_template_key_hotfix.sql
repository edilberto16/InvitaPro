-- InvitaPro v2.5.1 — Hotfix template key
begin;
...
begin
 ...
 insert into public.invitaciones(evento_id,titulo,slug,estado,modalidad,template_key,contenido)
 values(v_evento,trim(p_nombre_evento),v_slug,'borrador','autoservicio',p_plantilla_id,
 jsonb_build_object('mensaje',nullif(trim(coalesce(p_mensaje,'')),''),'creado_por','cliente','wizard_version','2.5.1'))
