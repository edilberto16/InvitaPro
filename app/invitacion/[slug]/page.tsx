...
const plantilla=String(design.plantilla||'elegante-classic');const templateEngine=resolveTemplateEngine(plantilla,data.invitacion.color_principal);const studioTheme=resolveThemeStudio(design.theme_id);const inviteStyle={...templateEngineStyle(templateEngine),...themeStudioStyle(studioTheme)};
