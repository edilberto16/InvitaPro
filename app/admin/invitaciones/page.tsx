...
const TEMPLATE_CATALOG=[
  ...
  {id:'superheroes',name:'Power Heroes',collection:'infantil',badge:'Disponible',available:true,color:'#e22d32',description:'Heroes de colores, energia, rayos y accion para cumpleanos.',layout:'hero'},
                  ...
                  <article className="media-upload-card audio-manager-card">
                    ...
                    {form.musica_url&&<div className="audio-file-status">
                      ...
                      <div>
                        ...
                        <small>{form.musica_url.startsWith('/demo/')?'Pista de demostración incluida':'Archivo cargado correctamente'}</small>
                      </div>
                    </div>}
