...
type AuthUser={id:string;email:string;created_at:string;last_sign_in_at:string|null;email_confirmed_at:string|null;is_current_admin:boolean;client:{id:string;nombre:string;correo:string|null;user_id:string}|null};
