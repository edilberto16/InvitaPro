...
const FEATURED_IDS = new Set(['midnight-gold', 'ivory-editorial', 'royal-amethyst', 'luxury-black', 'golden-night', 'espacial', 'campamento-bosque', 'noche-de-fogata', 'aviva']);
const NEW_IDS = new Set(['midnight-gold', 'midnight-platinum', 'midnight-sapphire', 'ivory-editorial', 'blush-editorial', 'terracotta-editorial', 'royal-amethyst', 'royal-rose', 'royal-emerald', 'campamento-bosque', 'noche-de-fogata', 'aviva']);
