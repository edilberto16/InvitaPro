...
const definitions: Record<string, TemplateEnginePreset> = {
  ...
  'noche-de-fogata': { family:'campamento', layout:'immersive', typography:'rounded', decoration:'sparkle', sectionOrder:['hero','intro','countdown','details','program','video','gallery','faq','location','rsvp'], palette:{primary:'#f28b3c',secondary:'#f4c36c',background:'#1b1412',surface:'#30211b',text:'#fff5e7',muted:'#d8b9a2'} },
  'retiro-en-la-montana': { family:'campamento', layout:'editorial', typography:'serif', decoration:'botanical', sectionOrder:['hero','intro','details','program','lodging','special_people','gallery','faq','location','rsvp'], palette:{primary:'#6d8fa1',secondary:'#c7d6d7',background:'#eef2ef',surface:'#ffffff',text:'#263b42',muted:'#718188'} },
  'amanecer-con-dios': { family:'campamento', layout:'classic', typography:'serif', decoration:'ornamental', sectionOrder:['hero','intro','countdown','details','program','history','gallery','faq','location','rsvp'], palette:{primary:'#e8a35c',secondary:'#f2d7a6',background:'#fff7e8',surface:'#ffffff',text:'#5a402c',muted:'#9b8067'} },
  'bajo-las-estrellas': { family:'campamento', layout:'immersive', typography:'modern', decoration:'cosmic', sectionOrder:['hero','intro','countdown','details','program','video','gallery','hashtag','faq','location','rsvp'], palette:{primary:'#8c8fe8',secondary:'#d3b9ff',background:'#090b25',surface:'#16183c',text:'#f5f3ff',muted:'#b4b5d8'} },
  'senderos-de-fe': { family:'campamento', layout:'classic', typography:'rounded', decoration:'botanical', sectionOrder:['hero','intro','details','program','history','gallery','faq','location','rsvp'], palette:{primary:'#7d9b67',secondary:'#c9d6ad',background:'#f2f3e8',surface:'#fffef8',text:'#344330',muted:'#7b8775'} },
  'aviva': { family:'campamento', layout:'immersive', typography:'modern', decoration:'geometric', sectionOrder:['hero','intro','countdown','details','program','special_people','video','gallery','hashtag','faq','location','rsvp'], palette:{primary:'#ef5f47',secondary:'#ffc857',background:'#161322',surface:'#262036',text:'#fff7ef',muted:'#c8bfd5'} },
