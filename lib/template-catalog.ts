...
export const TEMPLATE_CATALOG: TemplateDefinition[] = [
  ...
  { id:'dinosaurios', name:'Dinosaurios', collection:'infantil', badge:'Disponible', available:true, premium:false, color:'#598a64', description:'Una aventura jurásica divertida.', layout:'dino', features:['Escenario jurásico','Huella animada','Paleta verde'] },
