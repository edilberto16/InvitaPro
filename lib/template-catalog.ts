...
export const TEMPLATE_CATALOG: TemplateDefinition[] = [
  ...
  { id:'senderos-de-fe', name:'Senderos de Fe', collection:'campamento', badge:'Disponible', available:true, premium:false, familyName:'Campamentos de Fe', variantName:'Camino y crecimiento', color:'#7d9b67', description:'Senderos, bosque claro y una composición orgánica para jornadas de reflexión y crecimiento espiritual.', layout:'camp-trail', features:['Ruta de actividades','Preguntas frecuentes','Qué llevar'], searchTerms:['senderos','camino','fe','crecimiento espiritual','reflexión','reflexion','bosque','retiro'] },
  { id:'aviva', name:'Aviva', collection:'campamento', badge:'Disponible', available:true, premium:true, signature:true, familyName:'Campamentos de Fe', variantName:'Juventud y alabanza', color:'#ef5f47', description:'Energía juvenil, tipografía de festival y bloques dinámicos para congresos, campamentos y noches de alabanza.', layout:'camp-revival', features:['Programa tipo festival','Speakers y banda','Registro con transporte'], searchTerms:['aviva','congreso','festival','alabanza','banda','speakers','juventud','jóvenes','jovenes','iglesia'] },
